"""
Django settings for nyayasahayak project.
...
ROOT_URLCONF = 'nyayasahayak.urls'
...
WSGI_APPLICATION = 'nyayasahayak.wsgi.application'
...
# Additional static files directories (for frontend)
STATICFILES_DIRS = [
    BASE_DIR / 'static_frontend',
] if (BASE_DIR / 'static_frontend').exists() else []
